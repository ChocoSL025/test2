			...
			<div class="basic-form">
				<form class="col-sm-8">
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" name="kategori" placeholder="Jenis Pemasukan. co: Uang saku dari mama">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Pemasukan Dari</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="cKategori" id="nama_tipe" placeholder="Pemasukan dari co: OVO / TUNAI ">
						</div>
